...
<div id="innerMenubar">
  <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('outProductAction_print','_self');this.blur();">打印E</a></li>
	<li id="save"><a href="#" onclick="formSubmit('outProductAction1_print','_self');this.blur();">打印P</a></li>
</ul>
  </div>
</div>
</div>
