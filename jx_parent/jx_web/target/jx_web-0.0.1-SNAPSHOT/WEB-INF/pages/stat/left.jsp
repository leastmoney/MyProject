        ...
        <div class="panel-content">
			 <ul>
				<li><a href="${ctx}/stat/statChartAction_factorySale" onclick="linkHighlighted(this)" target="main" id="aa_1">生产厂家销售情况</a></li>
				 <li><a href="${ctx}/stat/statChartAction_factorySaleJson" onclick="linkHighlighted(this)" target="main" id="aa_1">生产厂家销售情况echarts</a></li>
				...
				<li><a href="${ctx}/stat/statChartAction_onlineInfo" onclick="linkHighlighted(this)" target="main" id="aa_1">系统访问压力图</a></li>
				 <li><a href="${ctx}/stat/statChartAction_onlineInfoJson" onclick="linkHighlighted(this)" target="main" id="aa_1">系统访问压力图echarts</a></li>
			</ul>
